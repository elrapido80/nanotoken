...
static const char *strDNSSeed[][2] = {
    {"r3wtsb0x", "173.216.107.57"},
	{"mullickServer", "192.64.86.238"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. NanoTokens is probably already running."), addrBind.ToString().c_str());
        else
